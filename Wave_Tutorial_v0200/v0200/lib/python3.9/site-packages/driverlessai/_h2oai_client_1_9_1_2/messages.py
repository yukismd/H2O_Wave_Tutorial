...
class DisparateImpactAnalysisParameters:
    ...
    """
    def __init__(self, model_key, mli_key, dia_key, config_overrides, model_path, tmp_dir_path, dataset_path, mli_dir_path, classes, intr_params, dia_entity, roc, labels, cut_off, path, actual_col, predict_column, maximize_metric) -> None:
        validation.validate_toml(config_overrides, 'config_overrides')
        self.model_key = model_key
        self.mli_key = mli_key
        self.dia_key = dia_key
