...
class Client:
    ...
    def make_prediction(self, model_key: str, dataset_key: str, output_margin: bool, pred_contribs: bool, pred_contribs_original: bool, enable_mojo: bool, fast_approx_contribs: bool, keep_non_missing_actuals: bool, include_columns: List[str]) -> str:
        """

        """
        req_ = dict(model_key=model_key, dataset_key=dataset_key, output_margin=output_margin, pred_contribs=pred_contribs, pred_contribs_original=pred_contribs_original, enable_mojo=enable_mojo, fast_approx_contribs=fast_approx_contribs, keep_non_missing_actuals=keep_non_missing_actuals, include_columns=include_columns)
    ...
    def get_orig_shapley_zip_archive_url(self, key: str) -> str:
        """
...
# PATCHES
from . import protocol_patches_1_9

# 1.9
Client.get_mli_config_options = protocol_patches_1_9.get_mli_config_options
Client.interpretation_url_path = "/#/interpret_next"
Client.ts_interpretation_url_path = "/mli-ts"
Client.list_model_estimators = protocol_patches_1_9.ignore_unexpected_kwargs(Client.list_model_estimators)
Client.make_prediction = protocol_patches_1_9.ignore_unexpected_kwargs(Client.make_prediction)
Client.list_scorers = protocol_patches_1_9.ignore_unexpected_kwargs(Client.list_scorers)
Client.list_transformers = protocol_patches_1_9.ignore_unexpected_kwargs(Client.list_transformers)
